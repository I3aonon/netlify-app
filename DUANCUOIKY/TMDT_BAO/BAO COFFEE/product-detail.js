...
function populateProductDetails(product) {
  // Update page title
  document.title = `${product.name} - Bao coffee`;
...
function getProductDescription(product) {
  const descriptions = {
    ...
    "Đá xay":
      "Thức uống đá xay mát lạnh, hoàn hảo cho những ngày nóng bức. Được pha chế với công thức độc quyền của Bao coffee.",
    "Bánh ngọt":
  ...
  return (
    ...
    "Sản phẩm chất lượng cao từ Bao coffee."
  );
}
...
function loadProductDescription(product) {
  ...
  if (product.category === "Cà phê") {
    description = `
      <p><strong>${product.name}</strong> là một trong những sản phẩm đặc trưng của Bao coffee, được pha chế từ những hạt cà phê chất lượng cao được tuyển chọn kỹ lưỡng.</p>
    ...
    description = `
      ...
      <p>Được pha chế theo công thức độc quyền của Bao coffee, ${product.name} là lựa chọn lý tưởng cho những ai yêu thích sự nhẹ nhàng và tinh tế.</p>
      <p><strong>Đặc điểm nổi bật:</strong></p>
      <ul>
    ...
    description = `
      ...
      <ul>
        ...
        <li>Công thức độc quyền của Bao coffee</li>
    ...
    description = `
      <p><strong>${product.name}</strong> là một trong những sản phẩm chất lượng cao của Bao coffee, được chế biến với sự tỉ mỉ và tâm huyết.</p>
    ...
    .map(
      ...
      <div class="bakery-item-sidebar" onclick="viewProduct(${product.id})">
        ...
        <div class="bakery-item-info">
          <div class="bakery-item-brand">BAO COFFEE</div>
  ...
  container.innerHTML = sameCategoryProducts
    .map(
      ...
      <div class="same-category-item product-card" onclick="viewProduct(${
        ...
        <div class="product-info">
          <p class="product-category">BAO COFFEE</p>
          <h3 class="product-name">${product.name}</h3>
          <div class="product-price">
  ...
  if (typeof mockData !== "undefined") {
    ...
    window.products = [
      // Coffee products
      {
        ...
        price: 29000,
        image: "./public/c1.jpg",
        description: "Cà phê Bao coffee truyền thống với sữa đá thơm ngon.",
      },
      {
        id: 102,
        name: "Bạc Xỉu",
